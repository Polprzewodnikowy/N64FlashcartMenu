...
Fast reboot behavior for active 64DD sessions can still vary by flashcart firmware and game flow. If a reset returns a blank screen, reset again to return to menu.
